    ...
    <div class="col-xxl">
        <div class="card mb-4">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="mb-4 text-gray-800">Edit Penanggung Jawab</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="acara" name="acara" value="{{$pj->acara}}" required />
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group input-group-merge">
                                        <input type="text" id="penanggungjawab" name="penanggungjawab" class="form-control" value="{{$pj->penanggungjawab}}" required />
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" type="text" id="no_telp" name="no_telp" value="{{$pj->no_telp}}" required>
                                </div>
                            </div>
                            {{-- <hr class="mb-3 " />
                            <div class="row">
